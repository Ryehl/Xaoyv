...
/**
 * A tool for achieving a one-line global activity_release_scheme swipe back via using some {@link SwipeConsumer}
 * simple usage:
 * <code>
 *
     //add swipe translucent back performance for all activities
     // (default direction: left, previous activity_release_scheme related factor:0.5F)
    SmartSwipeBack.activitySlidingBack(this, new SmartSwipeBack.ActivitySwipeBackFilter() {
        public boolean onFilter(Activity activity_release_scheme) {
            return !(activity_release_scheme instanceof MainActivity);
        }
    });

     //add swipe back like mobile QQ (activity_release_scheme keep stay and finish activity_release_scheme with release velocity)
...
public class SmartSwipeBack {
    ...
    public interface SwipeBackConsumerFactory {
        /**
         * Create SwipeConsumer to do swipe back business for activity_release_scheme
         * @param activity activity_release_scheme to wrap with swipe back
    ...
    public interface ActivitySwipeBackFilter {
        /**
         * Determine whether the activity_release_scheme parameter should swipe back
         * @param activity The activity_release_scheme to wrap or not
    ...
    /**
     * The core function for global activity_release_scheme swipe back
     * @param application application
     * @param factory factory to create SwipeConsumer for each Activity
     * @param filter filter of activity_release_scheme, to determine which activity_release_scheme should finish via swipe motion
     */
    ...
    /**
     * find previous activity_release_scheme
     * @param fromActivity the given activity_release_scheme to find its previous
     * @return the previous activity_release_scheme if exists
    ...
    public static interface IPreviousFinder {
        /**
         * find the previous activity_release_scheme for the given activity_release_scheme
         * @param fromActivity activity_release_scheme given
         * @return the previous activity_release_scheme
         */
