...
public class SmartSwipe {
    ...
    /**
     * wrap an activity_release_scheme
    ...
    /**
     * peek wrapper for the specific activity_release_scheme, return the origin {@link SmartSwipeWrapper} if exists, else return null
     * @param activity activity_release_scheme
    ...
    /**
     * wrap a view in activity_release_scheme, view id is specified
