...
public abstract class SwipeConsumer {
    ...
    protected SwipeBackListener mBackListeners;
    /**
    ...
    protected void notifySwipeStateChanged(int state) {
        if (mBackListeners!=null){
            mBackListeners.onSwipeStateChanged(state);
        }
        for (SwipeListener listener : mListeners) {
            if (listener != null) {
    ...
    protected void notifySwipeStart() {
        if (mBackListeners!=null){
            mBackListeners.onSwipeStart(mDirection);
        }
        for (SwipeListener listener : mListeners) {
            if (listener != null) {
    ...
    protected void notifySwipeRelease(float xVelocity, float yVelocity) {
        if (mBackListeners!=null){
            mBackListeners.onSwipeRelease(mDirection, mProgress, xVelocity, yVelocity);
        }
        for (SwipeListener listener : mListeners) {
            if (listener != null) {
    ...
    protected void notifySwipeProgress(boolean settling) {
        if (mBackListeners!=null){
            mBackListeners.onSwipeProcess(mDirection, settling, mProgress);
        }
        for (SwipeListener listener : mListeners) {
            if (listener != null) {
     ...
     * @see SimpleSwipeListener
     */
    public SwipeConsumer setSwipeListener(SwipeBackListener listener) {
        mBackListeners = listener;
        return this;
    }
