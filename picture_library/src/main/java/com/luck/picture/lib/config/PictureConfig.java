...
public final class PictureConfig {
    ...
    public final static String NEEDNOT_DOWNLOAD = "need_not_download";
    ...
    public final static int CHOOSE_JUSTREQUEST = 210;

    public final static int CHOOSE_BACKREQUEST = 211;
    public final static int CHOOSE_HOLDREQUEST = 212;
}
