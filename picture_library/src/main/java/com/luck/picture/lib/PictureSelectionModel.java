...
public class PictureSelectionModel {
     ...
     * @param medias
     */
    public void openExternalPreviewNoDownload(int position, String directory_path, List<LocalMedia> medias) {
        if (selector != null) {
            selector.externalPicturePreviewNoDownload(position, directory_path, medias);
        } else {
            throw new NullPointerException("This PictureSelector is Null");
        }
    }
